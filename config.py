...
# WordPress Setup
# Replace the values with your information
#wpuser = 'photobooth_3ncdcs'
#wppass = 'EwY5 b27C CYJg zWRU 4lXn 9y5y'
#wpurl = 'https://photobooth.senzabidet.com/wp-json/wp/v2'
#
# Change these according to where you're taking the photobooth
# for example, for a birthday party or at some special place
#wp_title = 'Scality goofballs'
#wp_content = 'Fun in the office at Scality.'
...
camera_iso = 200    # adjust for lighting issues. Normal is 100 or 200. Sort of dark is 400. Dark is 800 max.
